...
const DICT: Record<string, Entry> = {
  ...
  "home.why1.desc": {
    ko: "코레일·SRT 좌석을 실시간으로 조회하고 바로 예매하세요.",
    en: "Search Korail & SRT seats live and book in seconds.",
  },
  "home.why2.title": { ko: "외국인도 간편하게", en: "Made for travelers" },
  "home.why2.desc": {
    ko: "다국어 지원과 해외 카드 결제로 누구나 쉽게 예매할 수 있어요.",
    en: "Multilingual and overseas card payments built in.",
  },
  ...
  "sr.timeMorning": { ko: "오전", en: "Morning" },
  "sr.timeAfternoon": { ko: "오후", en: "Afternoon" },
  "sr.timeEvening": { ko: "저녁", en: "Evening" },
